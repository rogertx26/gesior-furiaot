												...
												<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif);">
													<div class="TableContentContainer">
														<table class="TableContent" width="100%">
															...
															$ticketsOpen = $SQL->query("SELECT * FROM tickets WHERE ticket_status = 'Aguardando' AND ticket_admin_reply = 0");
												...
												<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif);">
													<div class="TableContentContainer">
														<table class="TableContent" width="100%">
															...
															$accId = $account_logged->getID();
															$ticketsOpen = $SQL->query("SELECT * FROM tickets WHERE ticket_status = 'Respondido' AND ticket_admin_reply = 1");
															foreach($ticketsOpen as $resultadoOpen){
															$main_content .= '<tr bgcolor="">
																		<td width="75%">
																			<a href="?subtopic=ticket&amp;action=showticket&amp;do=number&amp;id='.$resultadoOpen['ticket_id'].'">#'.$resultadoOpen['ticket_id'].'</a>
												...
												<div class="TableContentAndRightShadow" style="background-image:url('.$layout_name.'/images/global/content/table-shadow-rm.gif);">
													<div class="TableContentContainer">
														<table class="TableContent" width="100%">
															...
															$accId = $account_logged->getID();
															$ticketsClosed = $SQL->query("SELECT * FROM tickets WHERE ticket_status = 'Fechado'");
