...
$news_content .= '
	<div id="NewsTicker" class="Box">
    	...
    	<img id="ContentBoxHeadline" class="Title" src="'.$layout_name.'/images/global/content/headline-newsticker.gif" alt="Contentbox headline">
    	<div class="Border_2">
      		<div class="Border_3">
...
//Featured Article
	$news_content .= '
		<div id="FeaturedArticle" class="Box">
			...
			<div class="Border_1" style="background-image:url('.$layout_name.'/images/global/content/border-1.gif);"></div>
			<div class="BorderTitleText" style="background-image:url('.$layout_name.'/images/global/content/title-background-green.gif);"></div>
			<img id="ContentBoxHeadline" class="Title" src="'.$layout_name.'/images/global/content/headline-featuredarticle.gif" alt="Contentbox headline">
    		<div class="Border_2">
      			<div class="Border_3">
        			<div class="BoxContent" style="background-image:url('.$layout_name.'/images/global/content/scroll.gif);">
				 ...
				 <font size="2px"></font><font size="2px"><b>'.$config['server']['serverName'].'</b> - <a href="?subtopic=serverinfo" <b="">Server Info</a> - <small>(aprenda a <b><a href="?subtopic=serverinfo&action=tutorialdonate" <b="">Donatar</a></b> e usar nosso <b><a href="?subtopic=serverinfo&action=tutorialshop" <b="">Shop Online</a></b>)</small> <br><br> Bem-vindo ao <b><font color="green">'.$config['server']['serverName'].'</font></b>, mapa totalmente customizado com diversas areas unicas do nosso servidor, Reworked Cooldown e Spells para melhor dinamica do PvP.<br>Bugs corrigidos diariamente. Venha jogar o melhor servidor baiak da atualidade! <br><a href="?subtopic=createaccount" <b="">Cria sua conta</a> e sua diversão e garantida!
                </font> </div>
						<a id="Link" href="?subtopic=newsarchive&view=1">» read more</a>
						</div>
      				</div>
    			</div>
			<div class="Border_1" style="background-image:url('.$layout_name.'/images/global/content/border-1.gif);"></div>
											...
											<tr class="Table" style="background-color: #d4c0a1;">
												<td style="width: 800; border: 1px; border-style: solid; border-color: #FAF0D7;">
													<div class="NewsHeadline">
														<div class="NewsHeadlineBackground" style="background: linear-gradient(#3d622b 0%, #182d0d 100%);border-bottom: 1px solid black;border-top: 1px solid black;">
															<table border="0">
																<tr>
...
//Here start news
    ...
    if(isset($last_threads[0]))
    {
        foreach($last_threads as $thread)
        {
            $main_content .= '
				<div class="NewsHeadline">
					<div class="NewsHeadlineBackground" style="background: linear-gradient(#3d622b 0%, #182d0d 100%);">
